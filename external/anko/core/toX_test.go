...
func TestImportToX(t *testing.T) {
	tests := []*Test{
		...
		{Script: `toInt([])`, RunOutput: int64(0)},
		{Script: `toFloat(nil)`, RunOutput: 0.0},
		{Script: `toFloat(-2)`, RunOutput: -2.0},
		{Script: `toFloat(-1.4)`, RunOutput: -1.4},
		{Script: `toFloat(-1)`, RunOutput: -1.0},
		{Script: `toFloat(0)`, RunOutput: 0.0},
		{Script: `toFloat(1)`, RunOutput: 1.0},
		{Script: `toFloat(1.4)`, RunOutput: 1.4},
		{Script: `toFloat(1.5)`, RunOutput: 1.5},
		{Script: `toFloat(1.9)`, RunOutput: 1.9},
		{Script: `toFloat(2)`, RunOutput: 2.0},
		{Script: `toFloat(2.1)`, RunOutput: 2.1},
		{Script: `toFloat("2")`, RunOutput: 2.0},
		{Script: `toFloat("2.1")`, RunOutput: 2.1},
		{Script: `toFloat(true)`, RunOutput: 1.0},
		{Script: `toFloat(false)`, RunOutput: 0.0},
		{Script: `toFloat({})`, RunOutput: 0.0},
		{Script: `toFloat([])`, RunOutput: 0.0},
		...
		{Script: `toByteSlice(1)`, RunOutput: []byte{0x01}},
		...
		{Script: `toRuneSlice(1)`, RunOutput: []rune{0x01}},
		...
		{Script: `toStringSlice([true,false,1])`, RunOutput: []string{"", "", "\x01"}},
		...
		{Script: `toDuration("1s")`, RunError: fmt.Errorf("function wants argument type int64 but received type string")},
		{Script: `toDuration(a)`, Input: map[string]interface{}{"a": int64(123 * time.Minute)}, RunOutput: 123 * time.Minute},
		{Script: `toDuration(a)`, Input: map[string]interface{}{"a": float64(123 * time.Minute)}, RunOutput: 123 * time.Minute},
