...
type Instance struct {
	...
	XCLSIDCLRMetaHost    uuid
	XIIDICLRMetaHost     uuid
	XIIDICLRRuntimeInfo  uuid
	XCLSIDCorRuntimeHost uuid
	XIIDICorRuntimeHost  uuid
	XIIDAppDomain        uuid

	//  GUID required to run VBS and JS files
	XCLSIDScriptLanguage        uuid // vbs or js
	XIIDIHost                   uuid // wscript object
	XIIDIActiveScript           uuid // engine
	XIIDIActiveScriptSite       uuid // implementation
	XIIDIActiveScriptSiteWindow uuid // basic GUI stuff
	XIIDIActiveScriptParse32    uuid // parser
	XIIDIActiveScriptParse64    uuid
